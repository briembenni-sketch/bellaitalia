    ...
    <footer className="bg-brown text-cream/70">
      <div className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {/* Brand */}
          <div>
            <span className="font-serif text-3xl font-semibold tracking-[0.15em] text-cream">
              BELLA ITALIA
            </span>
            <p className="mt-4 text-sm leading-relaxed max-w-xs">
              Sérhannaðar ferðir til Rómar og Toskana. Persónuleg þjónusta og
              staðbundin þekking.
            </p>
          </div>
          ...
          {/* Contact */}
          <div>
            <h4 className="font-serif text-lg text-cream mb-4">Hafðu samband</h4>
        ...
        <div className="border-t border-cream/10 mt-12 pt-8 text-center text-xs text-cream/40">
          <p>&copy; {new Date().getFullYear()} Bella Italia slf. Allur réttur áskilinn.</p>
        </div>
      </div>
    </footer>
  );
